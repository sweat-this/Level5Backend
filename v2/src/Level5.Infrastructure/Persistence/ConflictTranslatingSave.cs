...
{
    /// <summary>
    /// Commits pending changes, translating a unique-constraint violation into the
    /// application-level <see cref="ConflictException"/>.
    ///
    /// Only <c>23505</c> (unique_violation) is translated. Every other database failure - data
